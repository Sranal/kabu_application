...
// 商品ID　[ down ] 新支付  id 75704
$redirect_url = URL_DOMAIN . '/LP/pay/pay_end_gentei.html';
$client_ip = '75704';
// 获取对应金额
...
<ul>
    ...
    <li class="p1">
        <div class="content2 p1h">
            ...
            <div class="e2"><img src="img/neo1.png" data-aos="fade-up" data-aos-easing="ease-out-cubic"
                                 data-aos-duration="300" data-aos-delay="300"></div>
            <div class="e4"><img src="img/neo4.png" data-aos="fade-up" data-aos-easing="ease-out-cubic"
                                 data-aos-duration="300" data-aos-delay="300"></div>

            <div class="ybg">
                <div class="e5"><img src="img/neo5.png" data-aos="fade-up" data-aos-easing="ease-out-cubic"
                                     data-aos-duration="300" data-aos-delay="300"></div>
            </div>
        </div>
    </li>
            ...
            <div class="p_box">
                <div class="p_right">
                    ...
                    <div class="form_box">
                        ...
                        <div class="form_e">
                            <input name="name" id="name" type="text"
                                   value="<?php echo isset($user_info['name']) ? $user_info['name'] : ''; ?>"
                                   placeholder="氏名" />
                            <p class="error-tip error-name">お名前を入力してください。</p>
                        </div>
                        <div class="form_e">
                            <input name="name_kana" id="name_kana" type="text"
                                   value="<?php echo isset($user_info['name_phonetic']) ? $user_info['name_phonetic'] : ''; ?>"
                                    placeholder="フリガナ"/>
                            <p class="error-tip error-name_kana">フリガナを入力してください。</p></div>
                        <div class="form_e">
                            <input name="tel"
                                   value="<?php echo isset($user_info['tel']) ? $user_info['tel'] : ''; ?>"
                                   oninput="value=value.replace(/[^\d]/g,'')" id="tel" maxlength="11" pattern="[0-9]*"
                                   type="text" placeholder="電話番号"/>
                            <p class="error-tip error-tel">電話番号の形式が正しくありません。</p></div>
                        <div class="form_e">
                            <input name="email"
                                   value="<?php echo isset($user_info['mail_address']) ? $user_info['mail_address'] : ''; ?>"
                        ...
                        <div class="com_list">
                            <ul>
                                <li class="pborder">
                                    ...
                                    <div class="title_set">
                                        <div class="title1">限定商品</div>
                                        <div class="title2">「先乗り株カレッジ：限定版」</div>
                                        <div class="title3"></div>
                                    </div>
                                    <div class="num">350,000<span>円</span></div>
                                </li>
                                <li>
                                    <div class="th"><img src="img/e4.png"></div>
                                    <div class="title_set">
                    ...
                    <div class="tokuten_txt">
                        ①リアルタイム銘柄配信の情報配信サービス<br/>
                        ②業界最高峰の、もっと先乗り情報分析サービス<br/>
                        ③生放送＆録画配信「源太ライブ視聴権」<br/>
                        ④一般には出回らない上流情報の視聴権<br/>

                    </div>

                    <div class="tokuten_title">上が継続している間、永久に完全無料！！</div>
                    ...
                    <div class="white_box">
                        ...
                        <div class="com_list">
                            <ul>
                                ...
                                <li class="pborder">
                                    <div class="th"><img src="img/e24.png"></div>
                                    <div class="title_set">
                                        <div class="title1">７万円から１億円を達成させた本人による</div>
                                        <div class="title2">「決算ギャンブルの手法」<br/>「リアルタイム銘柄配信サービス」
                                        </div>
                                        <div class="title3">
                                            ※初期費用：110,000円（6ヶ月間)＆7ヶ月目以降：月額11,000円が無料
                                        </div>
                                    </div>
                                    <div class="num2">
                                ...
                                <li class="pborder">
                                    <div class="th"><img src="img/e25.png"></div>
                                    <div class="title_set">
                                ...
                                <li class="pborder">
                                    <div class="th"><img src="img/e26.png"></div>
                                    <div class="title_set">
                                        <div class="title1">生放送＆録画配信</div>
                                        <div class="title2">「源太ライブ視聴権」</div>
                                        <div class="title3">
                                            ※初期費用：132,000円（6ヶ月間)＆7ヶ月目以降：月額22,000円が無料
                                        </div>
                                    </div>
                                    <div class="num2">
                                        <div class="car_txt">カレッジ継続中は</div>
                                ...
                                <li class="pborder">
                                    <div class="th"><img src="img/e27.png"></div>
                                    <div class="title_set">
                                        <div class="title1">ブルームバーグ、クイック等</div>
                                        <div class="title2">一般には出回らない上流情報の視聴権</div>
                                        <div class="title3">※初期費用：33,000円（6ヶ月間)＆7ヶ月目以降：月額5,500円が無料
                                        </div>
                                    </div>
                                    <div class="num2">
                                        <div class="car_txt">カレッジ継続中は</div>
                                ...
                                <li class="pborder">
                                    <div class="th">
                                        <div class="th_left"><img src="img/e31.png"></div>
                                        <img src="img/e5.png"></div>
                                    <div class="title_set">
                                ...
                                <li class="pborder">
                                    <div class="th">
                                        <div class="th_left"><img src="img/e31.png"></div>
                                        <img src="img/e28.png"></div>
                                    <div class="title_set">
                                        <div class="title1"></div>
                                        <div class="title2">「源太流、プロ投資手法を取得する<br/>基礎＆常識オンライン講座」追加分の視聴
                                        </div>
    ...
    <li class="cl">
        ...
        Copyright (C) 先乗り株カレッジ限定版 - All Rights Reserved.
    </li>
            ...
            success:function(data){
                ...
                if(data.code==0) {
                    if(type==1) {
                        ...
                        location.href = '/LP/thx1/thxgentei.php';
                    }
                }
            },
            error:function (data) {

...
$client_ip = '';
$client_ip_credix = '1011004908';
$success_url = URL_DOMAIN . '/LP/pay/pay_end.html';
$error_url = URL_DOMAIN . '/LP/pay-f-member/index.php';


$redirect_url = URL_DOMAIN.'/LP/pay/pay_end.html';
$client_ip = CLIENT_IP;
// 获取对应金额
$goods_id = $input_form_obj->getGoodsInfoBygId($gid);
 ...
 */
function calculateAmountByValidDays($valid_days,$goods_price) {
    // 基础请求额（无有效期时的金额）
    $base_amount = $goods_price; // 通常価格
...
if (isset($_POST['type']) && $_POST['type'] == 'get_valid_days'){
    if (empty($_POST['tel'])) {
        echo json_encode(['code'=>['amount_info'=>['billing_amount'=>$goods_price,'discount_amount'=>0]],'valid_days'=>0]);die;
    } else {
    ...
    if ($valid_days > 0) {
        $amount_info = calculateAmountByValidDays($valid_days,$goods_price);
...
<ul>
    ...
    <li class="p1">
        <div class="content p1h">
            ...
            <div class="e1"><picture><source srcset="https://www.kabu-college.com/LP/pay-f-new/img/e1.png" media="(min-width: 460px)"><img src="https://www.kabu-college.com/LP/pay-f-new/img/e1.png"  data-aos="fade-up" data-aos-easing="ease-out-cubic" data-aos-duration="300" data-aos-delay="300"></picture></div>
        ...
        <div class="content2 p2h">
            <div class="p_box">
                <div class="p_right">
                    ...
                    <div class="txt pc">
                        注文する商品をご確認いただき、よろしければご注文者情報を入力して、<br />
                        ご希望の決済方法のボタンを押して次にお進みください。
                    </div>

                    <div class="txt sp">
                        ご注文者情報を入力しお支払い方法を選択して「決済画面へ進む」を押してください。
                    </div>
                    ...
                    <form id="pay" method="post" action="https://secure.credix-web.co.jp/cgi-bin/credit/order.cgi">
                        <div class="form_box">
                            ...
                            <input class="sendid" TYPE="hidden" NAME="sendid" value="">
                    ...
                    <!--
                    <div class="sp">
                      <a href="#" onclick="submit_sp()">
                        <div class="sppbtn">
                          <img src="https://www.kabu-college.com/LP/pay-f-new/img/spbtn.png" />
                        </div>
                      </a>
                    </div>
                    -->
                    ...
                    <div class="sp">
                        <div class="pbtn">
                            <a href="#" onclick="submit_card()">
                                <img src="https://www.kabu-college.com/LP/pay-f-new/img/c_btn.png" />
                            </a>
                        </div>
                        ...
                        <div class="pbtn">
                            <a href="#" onclick="submit_bank()">
                                <img src="https://www.kabu-college.com/LP/pay-f-new/img/b_btn.png" />
                            </a>
                        </div>
                    </div>

                    <div class="stxt" style="margin: 0 0 5% 0">
                        返金（返品）については
                        <a href="https://www.kabu-college.com/LP/pay/tokusyo.html" target="_blank">こちら</a>
                        をご確認ください。
                    </div>
                    ...
                    <div class="white_box mb20">
                        ...
                        <div class="com_list">
                            <ul>
                                <li class="pborder">
                                    <div class="th">
                                        <img src="https://www.kabu-college.com/LP/pay-f-new/img/e3.png" />
                                    </div>
                                    <div class="title_set">
                                        <div class="title1">【2026 年限定】最新商品</div>
                                        <div class="title2">先乗りAI 株カレッジFINAL</div>
                                        <div class="title3">限定・５つの禁断兵器</div>
                                    </div>
                                    <div class="num">550,000<span>円（税込）</span></div>
                                </li>
                                <li class="pborder">
                                    <div class="th">
                                        <img src="https://www.kabu-college.com/LP/pay/img/e3.png" />
                                    </div>
                                    <div class="title_set">
                                        <div class="title1">30名以上の億万長者を<br class="pc" />生み出した従来コンテンツ</div>
                                        <div class="title2">先乗り株カレッジ</div>
                                        <div class="title3"></div>
                                    </div>
                                    <div class="num"><div class="num3"><s>330,000</s><span>円（税込）</span></div><div class="num4">「無料」ですべて再稼働</div></div>
                                </li>

                                <li class="pborder">
                                    <div class="th">
                                        <img src="https://www.kabu-college.com/LP/pay-f-new/img/e4.png" />
                                    </div>
                                    <div class="title_set">
                                        <div class="title1">商品値引き</div>
                                        <div class="title2">２０万円割引</div>
                                        <div class="title3">受講経験者様・現受講生様限定</div>
                                    </div>
                                    <div class="num cred">▲200,000<span>円引き</span></div>
                                </li>

                                <li class="">
                                    <div class="th">
                                        <img src="https://www.kabu-college.com/LP/pay-f-new/img/e22.png" />
                                    </div>
                                    <div class="title_set">
                                        <div class="title1">「現受講生様（サポート期間内）」はさらに追加で値引き</div>
                                        <div class="title2">残存期間分を日割りで清算</div>
                                        <div class="title3">参加時の電話番号を入力すると割引金額が算出されます</div>
                                    </div>
                                    <div class="num cred"><span>ご請求欄でご確認</span></div>
                                </li>
                    ...
                    <div class="num_set set1">
                        <ul>
                            <ol>
                                <div class="title_set">
                                    <div class="title2">項目</div>
                                </div>
                            </ol>
                            <ol>
                                <div class="num">価格</div>
                            </ol>
                        </ul>
                    </div>
                    ...
                    <div class="num_set set1">
                        <ul>
                            <li>
                                <div class="title_set">
                                    <div class="title2">FINAL 限定・５つの禁断兵器</div>
                                </div>
                            </li>
                            <li>
                                <div class="num">550,000<span>円</span><span class="small">（税込）</span></div>
                            </li>
                        </ul>
                    </div>

                    <div class="num_set set2">
                        <ul>
                            <li>
                                <div class="title_set">
                                    <div class="title2">先乗り株カレッジ<br class="sp">（通常330,000 円）</div>
                                </div>
                            </li>
                            <li>
                                <div class="num">0<span>円</span><span class="small">（無料プレゼント）</span></div>
                            </li>
                        </ul>
                    </div>
                    ...
                    <div class="num_set set1">
                        <ul>
                            <li>
                                <div class="title_set">
                                    <div class="title2 col_red">特別優待値引き</div>
                                </div>
                            </li>
                            <li>
                                <div class="num col_red">▲200,000<span>円</span></div>
                            </li>
                        </ul>
                    </div>

                    <div class="num_set set2-2 member_special_discount_pc">
                        <ul>
                            <li>
                                <div class="title_set">
                                    <div class="title2 col_red">現会員・移行調整値引き</div>
                                </div>
                            </li>
                            <li>
                                <div class="num">▲<span class="special_amount" style="font-size: 20px;"><span>円</span></div>
                            </li>
                        </ul>
                    </div>

                    <div class="num_set set3">
                        <ul>
                            <li>
                                <div class="title_set">
                                    <div class="title2">今回ご請求額</div>
                                </div>
                            </li>
                            <li>
                                <div class="num billing_amount">350,000<span>円</span></div>
                            </li>
                        </ul>
                    </div>

                    <div class="white_box2">
                        <div class="wb_title2">2026年は勉強の年ではありません。ただ「利益を刈り取る」ための収穫期です。</div>
                        <div class="wb_title2">【受講経験者様・現受講生様 特別優待】</div>
                        <div class="wb_title3">本来、合計価値88万円の集大成を、<strong>経験者様への優待として、</strong>53万円引きの「35万円（税込）」ですべて提供します。</div>
                        <div class="wb_title3"><strong>・システムの完全再始動（33万円相当 → 0円）</strong>⇒期限切れとなっていた「銘柄発掘システム」「サポート」「ディスカッション」などの全機能を、今回すべて最新仕様で再稼働いたします</div>
                        <div class="wb_title3"><strong>・継続応援割引（▲200,000円）</strong>⇒これまでの投資と信頼に敬意を表し、最新兵器『FINAL』を圧倒的な特別価格で提供いたします。 </div>
                        <div class="wb_title3"><strong>※現受講生（サポート期間内）の皆様へ</strong>⇒現在お支払いいただいている受講料については、残存期間分を日割りで全額精算（差し引き）いたします。 （参加時の電話番号を入力するだけで、システムが自動で最終決済額を算出します。一切の損はさせません）</div>
                    </div>

                    <div class="tokuten_title">【2026年限定】最新商品『先乗りAI株カレッジFINAL』</div>
                    ...
                    <div class="white_box">
                        ...
                        <div class="com_list">
                            <ul>
                                <li class="pborder">
                                    <div class="th">
                                        <img src="https://www.kabu-college.com/LP/pay-f-new/img/e23.png" />
                                    </div>
                                    <div class="title_set">
                                        <div class="vip">【FINAL専用】新コンテンツ</div>
                                        <div class="title1">禁断兵器①：次世代AI解析ツール（６カ月間）</div>
                                        <div class="title2">
                                            <div class="s_txt">ハゲタカの「足跡」を自動検出</div>
                                            AI源太『ハゲタカスコープ』
                                        </div>
                                    </div>
                                </li>
                                ...
                                <li class="pborder">
                                    <div class="th">
                                        <img src="https://www.kabu-college.com/LP/pay-f-new/img/e24.png" />
                                    </div>
                                    <div class="title_set">
                                        <div class="vip">【FINAL専用】新コンテンツ</div>
                                        <div class="title1">禁断兵器②：超実践型・週刊レポート（６カ月間）</div>
                                        <div class="title2">
                                            <div class="s_txt">収穫のカンニングシート</div>
                                            週刊・ハゲタカ『極秘監視ブラックリスト』
                                        </div>
                                    </div>
                                </li>
                                ...
                                <li class="pborder">
                                    <div class="th">
                                        <img src="https://www.kabu-college.com/LP/pay-f-new/img/e25.png" />
                                    </div>
                                    <div class="title_set">
                                        <div class="vip">【FINAL専用】新コンテンツ</div>
                                        <div class="title1">禁断兵器③：超実践型・週刊ビデオ（６カ月間）</div>
                                        <div class="title2">
                                            <div class="s_txt">大口の裏をかく知略</div>
                                            源太の手口暴露『週間裏読みビデオ』
                                        </div>
                                    </div>
                                </li>
                                ...
                                <li class="pborder">
                                    <div class="th">
                                        <img src="https://www.kabu-college.com/LP/pay-f-new/img/e26.png" />
                                    </div>
                                    <div class="title_set">
                                        <div class="vip">【FINAL専用】新コンテンツ</div>
                                        <div class="title1">禁断兵器④：複利最大化・勝利の全行程図解（視聴期限無し）</div>
                                        <div class="title2">
                                            <div class="s_txt">資産100倍シナリオ</div>
                                            2段ロケット『完全ロードマップ』
                                        </div>
                                        <div class="title3"></div>
                                    </div>
                                ...
                                <li>
                                    <div class="th">
                                        <img src="https://www.kabu-college.com/LP/pay-f-new/img/e27.png" />
                                    </div>
                                    <div class="title_set">
                                        <div class="vip">【FINAL専用】新コンテンツ</div>
                                        <div class="title1">禁断兵器⑤：オンラインコミュニティ（６カ月間）</div>
                                        <div class="title2">
                                            <div class="s_txt">プロの視点を完全同期</div>
                                            ハゲタカに勝つ！『銘柄研究会』
                                        </div>
                                        <div class="title3"></div>
                                    </div>
                    ...
                    <div class="white_box2">
                        <div class="wb_title1">FINAL完全付属<br />これまでの「先乗り株カレッジ」を、<br />最新仕様へアップデートして完全統合。</div>
                        <div class="wb_title2">全くの未経験から30名以上を「億万長者」へと変貌させた、実証済みの成功プログラムをすべて無料で再稼働します。</div>
                        <div class="wb_title3">銘柄・時期・資金配分——。<br />プロの視点で資産を安全・着実に増やす実績ある不変のロジックを、最新鋭の『FINAL』として再び使い倒してください。</div>
                    </div>
                    ...
                    <div class="white_box">
                        ...
                        <div class="com_list">
                            <ul>
                                ...
                                <li class="pborder">
                                    <div class="th">
                                        <img src="https://www.kabu-college.com/LP/pay/img/e5.png">
                                    </div>
                                    <div class="title_set">
                                        <div class="title1">デジタルコンテンツ（視聴期限無し）</div>
                                        <div class="title2">
                                            教え子が７万円から１億（1428倍）達成！<br />
                                            決算売買の裏技手法を公開
                                        </div>
                                        <div class="title3">※24時間限定プレゼント</div>
                                    </div>
                                ...
                                <li class="pborder">
                                    <div class="th">
                                        <img src="https://www.kabu-college.com/LP/pay/img/e6.png">
                                    </div>
                                    <div class="title_set">
                                        <div class="title1">デジタルコンテンツ（視聴期限無し）</div>
                                ...
                                <li class="pborder">
                                    <div class="th">
                                        <img src="https://www.kabu-college.com/LP/pay/img/e7.png">
                                    </div>
                                    <div class="title_set">
                                        <div class="title1">デジタルコンテンツ（視聴期限無し）</div>
                                        <div class="title2">
                                            市場の変化を先読みし利益最大化を狙う<br />
                                            「ポイントの日」の活用法＆実践編
                                        </div>
                                        <div class="title3"></div>
                                    </div>
                                ...
                                <li class="pborder">
                                    <div class="th">
                                        <img src="https://www.kabu-college.com/LP/pay/img/e8.png">
                                    </div>
                                    <div class="title_set">
                                        <div class="title1">デジタルコンテンツ（視聴期限無し）</div>
                                        <div class="title2">
                                ...
                                <li class="pborder">
                                    <div class="th">
                                        <img src="https://www.kabu-college.com/LP/pay/img/e9.png">
                                    </div>
                                    <div class="title_set">
                                        <div class="title1">デジタルコンテンツ（視聴期限無し）</div>
                                        <div class="title2">
                                ...
                                <li class="pborder">
                                    <div class="th">
                                        <img src="https://www.kabu-college.com/LP/pay/img/e10.png">
                                    </div>
                                    <div class="title_set">
                                        <div class="title1">自動ツール（６か月間）</div>
                                        <div class="title2">「自動お宝銘柄発掘ツール」利用権</div>
                                        <div class="title3"></div>
                                    </div>
                                ...
                                <li class="pborder">
                                    <div class="th">
                                        <img src="https://www.kabu-college.com/LP/pay/img/e11.png">
                                    </div>
                                    <div class="title_set">
                                ...
                                <li class="pborder">
                                    <div class="th">
                                        <img src="https://www.kabu-college.com/LP/pay/img/e12.png">
                                    </div>
                                    <div class="title_set">
                                ...
                                <li class="pborder">
                                    <div class="th">
                                        <img src="https://www.kabu-college.com/LP/pay/img/e13.png">
                                    </div>
                                    <div class="title_set">
                                        <div class="title1">半自動システム（６か月間）</div>
                                        <div class="title2">「簡単取引日記システム」利用権</div>
                                        <div class="title3"></div>
                                    </div>
                                    <div class="num2">セット商品</div>
                                </li>
                                ...
                                <li>
                                    <div class="th">
                                        <img src="https://www.kabu-college.com/LP/pay/img/e14.png">
                                    </div>
                                    <div class="title_set">
                    ...
                    <div class="white_box2">
                        <div class="wb_title2">【過去の受講生様へ】</div>
                        <div class="wb_title3"><strong>2026年は、もはや「勉強」のフェーズではありません。</strong><br />
                            今回の参加により、期限切れの全インフラを、即座に利益を刈り取るための『実戦仕様』として本日より6カ月間、再稼働します。<br />
                            <strong>学習のフェーズを終え、資産を爆増させるための「実戦」へ移行してください。</strong></div>
                    </div>
                    ...
                    <div class="ssl_box">
                        <ul>
                            <li>
                                ...
                                <div class="stxt">
                                    お客様情報はSSL暗号化技術を利用して厳重に送信いたします。<br />
                ...
                <div class="p_left pc">
                    <div class="cart_box">
                        ...
                        <div class="cnum member_special_discount_pc">
                            <ul>
                                <li class="cred">現会員特别割引</li>
                                <li class="cred">▲<span class="special_amount">0</span>円</li>
                            </ul>
                        </div>
                        <div class="cnum">
                            <ul>
                                <li class="cred">特別優待値引き</li>
                                <li class="cred">▲200,000円</li>
                            </ul>
                        </div>
                        ...
                        <div class="cnum mb20">
                            <ul>
                                <li>今回のご請求額</li>
                                <li class="cred total"><span class="billing_amount"><?php echo number_format($goods_price); ?></span>円</li>
                            </ul>
                        </div>
    ...
    $(function () {
        ...
        $('#tel').on('blur', function() {
            if ($('#tel').val()) {
                ...
                $('.member_special_discount').hide();
                $('.member_special_discount_pc').hide();
                $('.billing_amount').text('<?php echo number_format($goods_price); ?>');
    ...
    function updateAmountDisplay(amountInfo) {
        if (amountInfo && amountInfo.discount_amount !== undefined) {
            ...
            if (amountInfo.discount_amount > 0) {
                // 更新现会员特别割引额（确保转为数字再格式化，JSON 可能传来字符串）
                $('.special_amount').text(Number(amountInfo.discount_amount).toLocaleString('ja-JP'));
            ...
            // 更新最终请求额（JSON 可能传来字符串，必须先转成数字 toLocaleString 才会加千分位）
            $('.billing_amount').text(Number(amountInfo.billing_amount).toLocaleString('ja-JP'));

...
$redirect_url = URL_DOMAIN.'/LP/pay/pay_end_live.html';
$client_ip = CLIENT_IP;
$pay_url = 'https://secure.telecomcredit.co.jp/inetcredit/secure/order.pl?clientip='.CONTINUE_CLIENT_IP;
// 获取对应金额
...
<a href="https://www.kabu-college.com/LP/pay/tokusyo.html" target="_blank">こちら</a>をご確認ください。</div>
                    ...
                    <div class="white_box">
                        ...
                        <div class="com_list">
                            <ul>
                                <li class="border"><div class="th"><img src="https://www.kabu-college.com/LP/pay-f-s/img/e3.png"></div><div class="title_set"><div class="title1"></div><div class="title2">先乗り株カレッジ・LIVE視聴権</div><div class="title3">契約期間30日間</div></div><div class="num">20,000<span>円</span></div></li>
                    ...
                    <div class="num_set">
                        <ul>
                            <li><div class="title_set"><div class="title2">商品小計</div></div></li>
                            <li><div class="num">20,000<span>円(税別)</span></div></li></ul>
</div>
<div class="num_set set2 sp">
<ul>
<li><div class="title_set"><div class="title2">消費税</div></div></li>
<li><div class="num">2,000<span>円</span></div></li>
</ul>
</div>
<div class="num_set set3 sp">
<ul>
<li><div class="title_set"><div class="title2">今回ご請求額</div></li>
<li><div class="num">22,000<span>円</span></div></li>
                        </ul>
                    </div>
            ...
            success:function(data){
                ...
                if(data.code==0) {
                    if(type==1) {
                        ...
                        location.href = '/LP/thx1/thxlive.php';
                    }
                }
            },
            error:function (data) {

...
<ul>
    ...
    <li class="p1">
        <div class="content p1h">
            ...
            <div class="e1"><img src="img/PF001.png" data-aos="fade-up" data-aos-easing="ease-out-cubic"
...
<!--                        <input type="hidden" id="user_id" name="user_id" />-->
                    ...
                    <div class="white_box mb20">
                        ...
                        <div class="com_list">
                            <ul>
                                <li class="pborder">
                                    ...
                                    <div class="title_set">
                                        <div class="title1">期間限定特別セット</div>
                                        <div class="title2">「ポートフォリオ構築術」</div>
                                        <div class="title3"></div>
                                    </div>
                                    <div class="num">
                                        <div class="campain_txt">通常価格</div>
						...
						<div class="com_list">
                            <ul>
                                <li class="pborder">
                                    <div class="th"><img src="img/PF003.png"></div>
                                    <div class="title_set">
                                        <div class="title1">期間限定特別セット</div>
                                        <div class="title2">「マイ投資カレンダー作成術」</div>
                                        <div class="title3"></div>
                                    </div>
                                    <div class="num">
                                        <div class="campain_txt">通常価格</div>
                                        30,000<span>円（税込）</span></div>
                                </li>
                            </ul>
                        </div>
						...
						<div class="com_list">
                            <ul>
                                <li class="pborder">
                                    <div class="th"><img src="img/e4_blue.png"></div>
                                    <div class="title_set">
										<div class="title1">商品値引き</div>
                                        <div class="title2">33%割引</div>
                                        <div class="title3">※期間限定</div>
                                    </div>
                                    <div class="num cred">
                                        ▲33,000<span>円引き</span></div>
                    ...
                    <div class="num_set">
                        <ul>
                            <li>
                                <div class="title_set"><div class="title2">割引後の商品小計</div>
									<div class="title3">※期間限定特別価格</div>
                                </div>
                            </li>
                            <li>
                                <div class="num">65,000<span>円（税込）</span></div>
                            </li>
                        </ul>
                    </div>
                        ...
                        <div class="com_list">
                            <ul>
                                ...
                                <li class="pborder">
                                    ...
                                    <div class="title_set">
                                        <div class="title1">デジタルコンテンツ（視聴制限無し）</div>
                                        <div class="title2">マイ投資カレンダー作成術　解説動画</div>
                                    </div>
                                </li>
                                ...
                                <li class="pborder">
                                    ...
                                    <div class="title_set">
                                        <div class="title1">PDF形式（ダウンロード制限無し）</div>
                                        <div class="title2">マイ投資カレンダー作成用　自分で書き込める空白カレンダー</div>
                                    </div>
                                </li>
                    ...
                    <div class="pay_txt">
                        ※特別セットのみクレジットカードと銀行振込に対応しております。<br/>単体でのご購入は <span>銀行振込のみ</span>となりますので、ご注意ください。<br/>
                        <br/>
						<br/>
						「ポートフォリオ構築術」のみを<br/>
                        68,000円（税込）で購入する場合は⇒<a href="/LP/sakinori_pay2_pf/index2_pf_d.php">こちら</a><br/>
						<br/>
						「マイ投資カレンダー作成術」のみを<br/>
						 30,000円（税込）で購入する場合は⇒<a href="/LP/sakinori_pay2_pf/index3_cl_d.php">こちら</a><br/>
                    </div>
                        ...
                        <ul>
                            <li>
                                ...
                                <div class="stxt">お客様情報はSSL暗号化技術を利用して厳重に送信いたします。<br/>
                                    また、ご入力いただいたカード情報は株式会社クレディックスに決済代行を委託しております。<br/>
...
投資に関する最終決定はお客様ご自身の判断でお願いします。<br>ｘ

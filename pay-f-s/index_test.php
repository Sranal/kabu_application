...
$redirect_url = URL_DOMAIN . '/LP/thx1/thxpfcl.php';
$success_url = URL_DOMAIN . '/LP/thx1/thxpfcl.php';
$error_url = URL_DOMAIN . '/LP/sakinori_pay2_pf/index1_pfcl_d.php';
...
<div class="head_img"><img src="https://www.kabu-college.com/LP/pay-f-s/img/head_img.png" data-aos="fade-up" data-aos-easing="ease-out-cubic" data-aos-duration="300" data-aos-delay="300"></div>
      ...
      <div class="p_right">
        ...
        <div class="sp">
          <a href="#" onclick="submit_sp()">
            <div class="sppbtn">
              <img src="https://www.kabu-college.com/LP/pay-f-s/img/spbtn.png" />
            </div>
          </a>
        </div>
        -->
        ...
        <div class="sp">
          <div class="pbtn">
            <a href="#" onclick="submit_card()">
              <img src="https://www.kabu-college.com/LP/pay-f-s/img/c_btn.png" />
            </a>
          </div>
          ...
          <div class="pbtn">
            <a href="#" onclick="submit_bank()">
              <img src="https://www.kabu-college.com/LP/pay-f-s/img/b_btn.png" />
            </a>
          </div>
        </div>
        ...
        <div class="white_box mb20">
          ...
          <div class="com_list">
            <ul>
              <li>
                <div class="th">
                  <img src="https://www.kabu-college.com/LP/pay-f-s/img/e3.png" />
                </div>
                <div class="title_set">
                  <div class="title1">【梅】スタンダード</div>
                  <div class="title2">プロ思考・個人実践プログラム</div>
        ...
        <div class="num_set set2 sp">
          <ul>
            ...
            <li>
              <div class="num">400,000<span>円</span></div>
            </li>
          </ul>
        </div>
        ...
        <div class="num_set set2 sp">
          <ul>
            <li>
              <div class="title_set">
                <div class="title2">消費税</div>
              </div>
            </li>
            <li>
              <div class="num">40,000<span>円</span></div>
            </li>
          </ul>
        </div>
        ...
        <div class="num_set set3 sp">
          <ul>
            ...
            <li>
              <div class="num">440,000<span>円</span></div>
            </li>
          </ul>
        </div>

        <div class="tokuten_title">【梅】スタンダード『プロ思考・個人実践プログラム』</div>
        ...
        <div class="white_box">
          ...
          <div class="com_list">
            <ul>
              <li class="pborder">
                <div class="th">
                  <img src="https://www.kabu-college.com/LP/pay-f-s/img/e5.png" />
                </div>
                <div class="title_set">
                  <div class="title1">不定期レポート＆メッセージ配信（６カ月間）</div>
                  <div class="title2">
                    <div class="s_txt">富のインテリジェンス</div>
                    『極秘・解析プロセス「実況ログ」』
                  </div>
                </div>
              </li>
              ...
              <li class="pborder">
                <div class="th">
                  <img src="https://www.kabu-college.com/LP/pay-f-s/img/e6.png" />
                </div>
                <div class="title_set">
                  <div class="title1">不定期チェック（６カ月間）</div>
                  <div class="title2">
                    <div class="s_txt">分析のズレを即座に矯正</div>
                    源太直伝『最終ロジック監修』
                  </div>
                </div>
              </li>
              ...
              <li class="pborder">
                <div class="th">
                  <img src="https://www.kabu-college.com/LP/pay-f-s/img/e14.png" />
                </div>
                <div class="title_set">
                  <div class="title1">情報配信サービス（６カ月間）</div>
                  <div class="title2">
                    <div class="s_txt">伝説の1428倍を極限追求</div>
                    満中直伝『決算攻略・錬金プロトコル』
                  </div>
                  <div class="title3"></div>
                </div>
              ...
              <li class="pborder">
                <div class="th">
                  <img src="https://www.kabu-college.com/LP/pay-f-s/img/e13.png" />
                </div>
                <div class="title_set">
                  <div class="title1">情報配信サービス（６カ月間）</div>
                  <div class="title2">
                    <div class="s_txt">富の先乗り強奪</div>
                    最上流『情報分析・速報レポート』
                  </div>
                  <div class="title3"></div>
                </div>
              ...
              <li class="pborder">
                <div class="th">
                  <img src="https://www.kabu-college.com/LP/pay-f-s/img/e12.png" />
                </div>
                <div class="title_set">
                  <div class="title1">デジタルコンテンツ（視聴期限無し）</div>
                  <div class="title2">
                    <div class="s_txt">罠を逆利用して『爆益機会』に変える</div>
                    『アルゴリズム・トレース解析』
                  </div>
                  <div class="title3"></div>
                </div>
              ...
              <li class="pborder">
                <div class="th">
                  <img src="https://www.kabu-college.com/LP/pay-f-s/img/e7.png" />
                </div>
                <div class="title_set">
                  <div class="title1">デジタルコンテンツ（視聴期限無し）</div>
                  <div class="title2">
                    <div class="s_txt">機関投資家（ハゲタカ）を焼き尽くす</div>
                    『四大・裏技マスター講義』
                  </div>
                  <div class="title3">※コンテンツには以下の４つが含まれます</div>
                </div>

              </li>

              <li class="pborder indent">
                <div class="th">
                  <img src="https://www.kabu-college.com/LP/pay-f-s/img/e8.png" />
                </div>
                <div class="title_set">
                  ...
                  <div class="title1">ハゲタカの運用サイクルを逆手に取った利益最大化</div>
                  <div class="title3"></div>
                </div>
              ...
              <li class="pborder indent">
                <div class="th">
                  <img src="https://www.kabu-college.com/LP/pay-f-s/img/e9.png" />
                </div>
                <div class="title_set">
                  <div class="title2">
                    ②イベント・ドリブン爆速先取り法
                  </div>
                  <div class="title1">新商品発表などのイベントなど、ハゲタカが仕掛ける「上昇気流」で利益最大化</div>
                  <div class="title3"></div>
                </div>
              ...
              <li class="pborder indent">
                <div class="th"><img src="https://www.kabu-college.com/LP/pay-f-s/img/e10.png" /></div>
                <div class="title_set">
                  <div class="title2">
                    ③規制解除V字ブースト術
                  </div>
                  <div class="title1">信用規制解除の爆発エネルギーで、短期間で資産をV字成長させるブースター</div>
                  <div class="title3"></div>
                </div>
              ...
              <li class="pborder indent">
                <div class="th">
                  <img src="https://www.kabu-college.com/LP/pay-f-s/img/e11.png" />
                </div>
                <div class="title_set">
                  <div class="title2">
                    ④信用期日・強制点火狙い
                  </div>
                  <div class="title1">ハゲタカが仕掛けた空売りの、期限切れ強制買いを狙い撃ちした爆益手法</div>
                  <div class="title3"></div>
                </div>
              ...
              <li>
                <div class="th">
                  <img src="https://www.kabu-college.com/LP/pay-f-s/img/e20.png" />
                </div>
                <div class="title_set">
                  <div class="title1">シークレット交流（６カ月間）</div>
                  <div class="title2">
                    <div class="s_txt">最上流の情報と真の選民階級へ</div>
                    『億への招待・シークレット晩餐会』
                  </div>
                  <div class="title3"></div>
                </div>
   ...
   function addNewInfo() {
    ...
    $.ajax({
        ...
        success: function(data) {
            if (data.code == 0) {
                if (type == 1) {
                    // クレジット決済：隠しフォームに値をセットして送信
                    $('.credix_email').val($('#email').val());
                    $('.credix_tel').val($('#tel').val());
                    $('.credix_sendid').val(data.id);
                    
                    // 1秒待たずに即時実行
                    $('#pay_form_credix').submit();
                } else {
                    // 銀行振込
                    location.href = '/LP/thx1/thxpfcl_gin.php';
                }
            } else {
                alert('登録エラーが発生しました。');
            }
...
<form id="pay_form_credix" action="https://secure.credix.jp/cgi-bin/order.cgi" method="get">
    <input type="hidden" name="clientid" value="1011004743">
    <input type="hidden" name="item" value="f1102">
    <input type="hidden" name="money" value="<?php echo $goods_price; ?>">
    <input type="hidden" name="email" class="credix_email" value="">
    <input type="hidden" name="tel" class="credix_tel" value="">
    <input type="hidden" name="sendid" class="credix_sendid" value="">
    <input type="hidden" name="printstr" value="1">
</form>
</body>
</html>

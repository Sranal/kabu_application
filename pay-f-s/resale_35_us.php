...
// ===== Credix 用パラメータ（★ここを自環境に合わせて調整） =====
// 決済成功/失敗時の戻り先
$success_url = URL_DOMAIN . '/LP/pay/pay_end.html';
$error_url   = URL_DOMAIN . '/LP/pay/pay_error.html';
// Credixのclientip（加盟店ごとに指定される値）
...
<ul>
    ...
    <li class="p1">
        <div class="content p1h">
            ...
            <div class="e1"><img src="https://www.kabu-college.com/LP/pay-f-s/img/e1.png" data-aos="fade-up" data-aos-easing="ease-out-cubic" data-aos-duration="300" data-aos-delay="300"></div>
...
<a href="https://www.kabu-college.com/LP/pay/tokusyo.html" target="_blank">こちら</a>をご確認ください。</div>
                    ...
                    <div class="white_box mb20">
                        ...
                        <div class="com_list">
                            <ul>
                                <li class="pborder"><div class="th"><img src="https://www.kabu-college.com/LP/pay-f-s/img/e3.png"></div><div class="title_set"><div class="title1">デジタルコンテンツ（視聴期限無し）</div><div class="title2">先乗り株カレッジ（通常価格）</div><div class="title3"></div></div><div class="num">350,000<span>円</span></div></li>
                                <li><div class="th"><img src="https://www.kabu-college.com/LP/pay-f-s/img/e4.png"></div><div class="title_set"><div class="title1">商品値引き</div><div class="title2">５万円割引</div><div class="title3">※３日間限定プレゼント</div></div><div class="num cred">▲50,000<span>円引き</span></div></li>
                            </ul>
                        </div>
                    ...
                    <div class="num_set">
                        <ul>
                            ...
                            <li><div class="num">300,000<span>円(税別)</span></div></li></ul>
</div>
...
<li><div class="num">330,000<span>円</span></div></li>
                    ...
                    <div class="white_box">
                        ...
                        <div class="com_list">
                            <ul>
                                <li class="pborder"><div class="th"><img src="https://www.kabu-college.com/LP/pay-f-s/img/e5.png"></div><div class="title_set"><div class="title1">デジタルコンテンツ（視聴期限無し）</div><div class="title2">教え子が７万円から１億（1428倍）達成！<br />
                                            決算売買の裏技手法を公開</div><div class="title3">※３日間限定プレゼント</div></div><div class="num2">特典プレゼント</div></li>

                                <li class="pborder"><div class="th"><img src="https://www.kabu-college.com/LP/pay-f-s/img/e6.png"></div><div class="title_set"><div class="title1">デジタルコンテンツ（視聴期限無し）</div><div class="title2">板読み短期投資法の解説動画</div><div class="title3">※３日間限定プレゼント</div></div><div class="num2">特典プレゼント</div></li>

                                <li class="pborder"><div class="th"><img src="https://www.kabu-college.com/LP/pay-f-s/img/e7.png"></div><div class="title_set"><div class="title1">デジタルコンテンツ（視聴期限無し）</div><div class="title2">市場の変化を先読みし利益最大化を狙う<br />
                                            「ポイントの日」の活用法＆実践編</div><div class="title3"></div></div><div class="num2">特典プレゼント</div></li>

                                <li class="pborder"><div class="th"><img src="https://www.kabu-college.com/LP/pay-f-s/img/e8.png"></div><div class="title_set"><div class="title1">デジタルコンテンツ（視聴期限無し）</div><div class="title2">新商品発表等のイベントに向かった<br />
                                            株価高騰を捉える手法</div><div class="title3"></div></div><div class="num2">特典プレゼント</div></li>

                                <li class="pborder"><div class="th"><img src="https://www.kabu-college.com/LP/pay-f-s/img/e9.png"></div><div class="title_set"><div class="title1">デジタルコンテンツ（視聴期限無し）</div><div class="title2">規制解除後の高確率反転を狙った<br />
                                ...
                                <li class="pborder"><div class="th"><img src="https://www.kabu-college.com/LP/pay-f-s/img/e10.png"></div><div class="title_set"><div class="title1">自動ツール（６か月間）</div><div class="title2">「自動お宝発見ツール」利用権</div><div class="title3"></div></div><div class="num2">セット商品</div></li>

                                <li class="pborder"><div class="th"><img src="https://www.kabu-college.com/LP/pay-f-s/img/e11.png"></div><div class="title_set"><div class="title1">オンライン補講コミュニティ（６か月間）</div><div class="title2">「お宝銘柄発掘ディスカッション」参加権</div><div class="title3"></div></div><div class="num2">セット商品</div></li>

                                <li class="pborder"><div class="th"><img src="https://www.kabu-college.com/LP/pay-f-s/img/e12.png"></div><div class="title_set"><div class="title1">追加指導＆交流（６か月間）</div><div class="title2">「月１～2回の定例セミナー」参加権</div><div class="title3"></div></div><div class="num2">セット商品</div></li>

                                <li class="pborder"><div class="th"><img src="https://www.kabu-college.com/LP/pay-f-s/img/e13.png"></div><div class="title_set"><div class="title1">半自動システム（６か月間）</div><div class="title2">「簡単日記システム」利用権</div><div class="title3"></div></div><div class="num2">セット商品</div></li>

                                <li class="pborder"><div class="th"><img src="https://www.kabu-college.com/LP/pay-f-s/img/e14.png"></div><div class="title_set"><div class="title1">サポート（６か月間）</div><div class="title2">回数無制限、電話＆メールサポート</div><div class="title3"></div></div><div class="num2">セット商品</div></li>
...
<!-- ===== Credix 決済送信用フォーム（TelecomCreditのlocation.hrefを置き換え） ===== -->
<form id="pay" method="post" action="https://secure.credix-web.co.jp/cgi-bin/credit/order.cgi" style="display:none;">
    <input type="hidden" name="clientip" value="<?php echo $client_ip_credix ?? ''; ?>"/>
    <input type="hidden" class="money" name="money" value=""/>
    <input type="hidden" class="sendid" name="sendid" value=""/>
    <input type="hidden" class="telno" name="telno" value=""/>
    <input type="hidden" class="email" name="email" value=""/>
    <input type="hidden" class="success_url" name="success_url" value="<?php echo $success_url ?? ''; ?>"/>
    <input type="hidden" class="failure_url" name="failure_url" value="<?php echo $error_url ?? ''; ?>"/>
</form>
    ...
    function addNewInfo() {
        ...
        $.ajax({
            ...
            success:function(data){
                ...
                if(data.code==0) {
                    if(type==1) {
                        // ===== CredixへPOST送信（TelecomCredit遷移を廃止） =====
                        $('.sendid').val(data.id);
                        $('.telno').val($('#tel').val());
                        $('.email').val($('#email').val());

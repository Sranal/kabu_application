...
<head>
  <meta charset="utf-8">
  <meta http-equiv="refresh" content="0; url=https://www.kabu-college.com/GIIkS">
  <title>Redirecting...</title>
</head>
<body>
  <p>自動的に移動します。移動しない場合は <a href="https://www.kabu-college.com/GIIkS">こちら</a> をクリックしてください。</p>
</body>
</html>
        ...
        <div class="content2 p2h">
            <div class="p_box">
                <div class="p_right">
                    ...
                    <div class="sp"><a href="#" onclick="submit_sp()"><div class="sppbtn"><img src="https://www.kabu-college.com/LP/pay-f-s/img/spbtn.png"></div></a></div>
                    ...
                    <div class="white_box mb20">
                        ...
                        <div class="com_list">
                            <ul>
                                <li class="pborder"><div class="th"><img src="https://www.kabu-college.com/LP/pay-f-s/img/e3.png"></div><div class="title_set"><div class="title1">デジタルコンテンツ（視聴期限無し）</div><div class="title2">先乗り株カレッジ</div><div class="title3"></div></div><div class="num">350,000<span>円</span></div></li>
                            </ul>
                        </div>
                ...
                if(data.code==0) {
                    if(type==1) {
                        location.href = 'https://secure.telecomcredit.co.jp/inetcredit/secure/order.pl?clientip='+client_ip+'&usrmail=' +
                            $('#email').val() + '&usrtel=' + $('#tel').val() + '&goodsId=41' + '&redirect_url='+redirect_url + '&money='+goods_price+'&sendid=' + data.id;
                    }else {

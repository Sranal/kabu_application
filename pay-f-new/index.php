...
$client_ip = '';
$client_ip_credix = '1011004907';
$success_url = URL_DOMAIN . '/LP/pay/pay_end.html';
$error_url = URL_DOMAIN . '/LP/pay-f-new/index.php';
                ...
                <div class="p_right">
                        ...
                        <div class="com_list">
                            <ul>
                                ...
                                <li class="pborder">
                                    ...
                                    <div class="num"><div class="num3"><s>330,000</s><span>円（税込）</span></div><div class="num4">新規の方へ「無料」プレゼント</div></div>
                                </li>
                                ...
                                <li>
                                    ...
                                    <div class="title_set">
                                        <div class="title1">新規の方限定・特別値引き</div>
                                        <div class="title2">２０万円割引</div>
                                        <div class="title3">※24 時間限定</div>
                                    </div>
                    ...
                    <div class="num_set set2-2">
                        <ul>
                            <li>
                                <div class="title_set">
                                    <div class="title2 col_red">新規の方限定・特別値引き</div>
                                </div>
                            </li>
                            <li>
                    ...
                    <div class="white_box2">
                        ...
                        <div class="wb_title2">【新規お申込みの方限定】</div>
                        <div class="wb_title3">本来、合計価値88万円の集大成を、<strong>経験者様への優待として、</strong>53万円引きの「35万円（税込）」ですべて提供します。</div>
                        <div class="wb_title3"><strong>・30名以上の億万長者を輩出した「先乗り株カレッジ」（33万円相当）</strong><span class="col_red">⇒今回、すべて「無料プレゼント」</span></div>
                        <div class="wb_title3"><strong>・最新AI・5つの禁断兵器「FINAL」（55万円相当）</strong><span class="col_red">⇒このページ限定で「20万円引き」</span></div>
                    </div>
                    ...
                    <div class="white_box2">
                        <div class="wb_title1">新規限定<br />先乗り株カレッジ（33万円相当）を、<br />無料プレゼント</div>
                        <div class="wb_title2">全くの未経験から30名以上を「億万長者」へと変貌させた、実証済みの成功プログラムをすべて無料で開放します。</div>
                        <div class="wb_title3">銘柄・時期・資金配分——。<br />プロの視点で資産を安全・着実に増やすための全ノウハウが、この「FINAL」に集約されています。</div>
                    </div>
                    ...
                    <div class="white_box2">
                        <div class="wb_title2">【新規の受講生様へ】</div>
                        <div class="wb_title3"><strong>2026年は、もはや「勉強」のフェーズではありません。</strong><br />
                            今回の参加により、従来のコンテンツを、<strong>即座に利益を刈り取るための『実戦仕様』として本日より6カ月間、無料プレゼントします。</strong><br />
                            受講生30名以上を「億」へと到達させた本物の武器を、2026年の爆益を仕留めるために活用してください。</div>
                    </div>
            ...
            success:function(data){
                ...
                if(data.code==0) {
                    if(type==1) {
                        ...
                        location.href = '/LP/thx1/thx1-new.php';
                    }
                }
            },
            error:function (data) {

...
<ul>
    ...
    <li class="p1">
        <div class="content p1h">
            ...
            <div class="e1"><picture><source srcset="https://www.kabu-college.com/LP/pay-f-v/img/e1.png" media="(min-width: 460px)"><img src="https://www.kabu-college.com/LP/pay-f-v/img/e1sp.png"  data-aos="fade-up" data-aos-easing="ease-out-cubic" data-aos-duration="300" data-aos-delay="300"></picture></div>
...
<div class="head_img"><img src="https://www.kabu-college.com/LP/pay-f-v/img/head_img.png" data-aos="fade-up" data-aos-easing="ease-out-cubic" data-aos-duration="300" data-aos-delay="300"></div>
      ...
      <div class="p_right">
        ...
        <div class="sp">
          <a href="#" onclick="submit_sp()">
            <div class="sppbtn">
              <img src="https://www.kabu-college.com/LP/pay-f-v/img/spbtn.png" />
            </div>
          </a>
        </div>
        -->
        ...
        <div class="sp">
          <div class="pbtn">
            <a href="#" onclick="submit_card()">
              <img src="https://www.kabu-college.com/LP/pay-f-v/img/c_btn.png" />
            </a>
          </div>
          ...
          <div class="pbtn">
            <a href="#" onclick="submit_bank()">
              <img src="https://www.kabu-college.com/LP/pay-f-v/img/b_btn.png" />
            </a>
          </div>
        </div>
        ...
        <div class="white_box mb20">
          ...
          <div class="com_list">
            <ul>
              <li class="pborder">
                <div class="th">
                  <img src="https://www.kabu-college.com/LP/pay-f-v/img/e3.png" />
                </div>
                <div class="title_set">
                  <div class="title1">【竹】ダイヤモンドVIP</div>
                  <div class="title2">専属スタッフ・マンツーマン</div>
              ...
              <li>
                <div class="th">
                  <img src="https://www.kabu-college.com/LP/pay-f-v/img/e4.png" />
                </div>
                <div class="title_set">
                  <div class="title1">商品値引き</div>
                  <div class="title2">５万円割引</div>
                  <div class="title3">先着30 名限定プレゼント</div>
                </div>
        ...
        <div class="num_set set1 sp">
          <ul>
            <li>
              <div class="title_set">
                <div class="title2">通常価格</div>
              </div>
            </li>
            <li>
              <div class="num">500,000<span>円</span></div>
            </li>
          </ul>
        </div>
        ...
        <div class="num_set set2-2 sp">
          <ul>
            <li>
              <div class="title_set">
                <div class="title2 col_red">割引額</div>
        ...
        <div class="tokuten_title">【竹】ダイヤモンドVIP『専属スタッフ・マンツーマン』</div>
        ...
        <div class="white_box">
          ...
          <div class="com_list">
            <ul>
              <li class="pborder">
                <div class="th">
                  <img src="https://www.kabu-college.com/LP/pay-f-v/img/e21.png" />
                </div>
                <div class="title_set">
                  <div class="vip">【竹】ダイヤモンドVIP専用</div>
                  <div class="title1">マンツーマン指導（６カ月間）</div>
                  <div class="title2">
                    <div class="s_txt">成功への強制連行</div>
                    プロ専属『マンツー・プロトコル』
                  </div>
                </div>
              </li>
              ...
              <li class="pborder">
                <div class="th">
                  <img src="https://www.kabu-college.com/LP/pay-f-v/img/e5.png" />
                </div>
                <div class="title_set">
              ...
              <li class="pborder">
                <div class="th">
                  <img src="https://www.kabu-college.com/LP/pay-f-v/img/e6.png" />
              ...
              <li class="pborder">
                <div class="th">
                  <img src="https://www.kabu-college.com/LP/pay-f-v/img/e14.png" />
                </div>
                <div class="title_set">
              ...
              <li class="pborder">
                <div class="th">
                  <img src="https://www.kabu-college.com/LP/pay-f-v/img/e13.png" />
                </div>
                <div class="title_set">
                  <div class="title1">情報配信サービス（６カ月間）</div>
                  <div class="title2">
              ...
              <li class="pborder">
                <div class="th">
                  <img src="https://www.kabu-college.com/LP/pay-f-v/img/e12.png" />
                </div>
                <div class="title_set">
              ...
              <li class="pborder">
                <div class="th">
                  <img src="https://www.kabu-college.com/LP/pay-f-v/img/e7.png" />
                </div>
                <div class="title_set">
                  <div class="title1">デジタルコンテンツ（視聴期限無し）</div>
                  <div class="title2">
              ...
              <li class="pborder indent">
                <div class="th">
                  <img src="https://www.kabu-college.com/LP/pay-f-v/img/e8.png" />
                </div>
                <div class="title_set">
              ...
              <li class="pborder indent">
                <div class="th">
                  <img src="https://www.kabu-college.com/LP/pay-f-v/img/e9.png" />
                </div>
                <div class="title_set">
                  <div class="title2">
                    ②イベント・ドリブン爆速先取り法
              ...
              <li class="pborder indent">
                <div class="th"><img src="https://www.kabu-college.com/LP/pay-f-v/img/e10.png" /></div>
                <div class="title_set">
                  <div class="title2">
                    ③規制解除V字ブースト術
                  </div>
              ...
              <li class="pborder indent">
                <div class="th">
                  <img src="https://www.kabu-college.com/LP/pay-f-v/img/e11.png" />
                </div>
                <div class="title_set">
                  <div class="title2">
                    ④信用期日・強制点火狙い
              ...
              <li>
                <div class="th">
                  <img src="https://www.kabu-college.com/LP/pay-f-v/img/e20.png" />
                </div>
                <div class="title_set">

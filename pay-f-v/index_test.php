    ...
    <div class="p_box">
      <div class="p_right">
        <div class="cart_error">
          <div class="title">※ご購入には会員ログインが必要です</div>
          <div class="txt"> ご登録のメールアドレスとパスワードを入力してください。 ※パスワードの初期設定はご登録のお電話番号です。ハイフンを入れずに電話番号を入力してください。&nbsp; </div>
        </div>
        <div class="form_box">
          ...
          <div class="white_box mb20">
            ...
            <div class="com_list">
              <ul>
               <div class="com_list">
<ul>
<li class="pborder"><div class="th"><img src="img/e3.png"></div><div class="title_set"><div class="title1">マンツーマン指導（<span class="lth">３ヶ月間</span>→４ヶ月間）</div><div class="title2">大岩川源太・完全継承マンツーマンプログラム</div><div class="title3"></div></div><div class="num">500,000<span>円</span></div></li>
</ul>
<div class="up_txt2">
...
１１．今だけ消費税分お値引き！<span class="col_red">（期間限定）</span><br />
                ...
                <li>
                  ...
                  <div class="title_set">
                    ...
                    <div class="title2">消費税分５万円割引</div>
                    <div class="title3">※期間限定限定プレゼント</div>
                  </div>
          ...
          <div class="num_set">
            <ul>
              <li>
                <div class="title_set">
                  <div class="title2">割引後の商品合計</div>
                  <div class="title3">※期間限定特別価格</div>
                </div>
              </li>
              <li>
                <div class="num">500,000<span>円（税込）</span></div>
              </li>
            </ul>
          </div>
                    ...
                    if(data.code==0) {
                        if(type==1) {
                            location.href = 'https://secure.telecomcredit.co.jp/inetcredit/secure/order.pl?clientip='+client_ip+'&usrmail=' +
                                $('#email').val() + '&usrtel=' + $('#tel').val() + '&redirect_url=https://www.kabu-college.com/LP/pay/pay_end.html' + '&money='+goods_price+'&sendid=' + data.id;
                        }else {

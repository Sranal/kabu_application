...
$redirect_url = URL_DOMAIN . '/LP/thx1/thxpfcl_test.php';
$success_url = URL_DOMAIN . '/LP/thx1/thxpfcl_test.php';
$error_url = URL_DOMAIN . '/LP/sakinori_pay2_pf/index1_pfcl_neo.php';
                        ...
                        <div class="com_list">
							...
							<div class="title_set">
								<div class="title1" align=left>
									...
									※また本商品は、コンテンツ内容に関する個別サポートは提供しておりません。動画の視聴方法やお支払い方法など、操作や手続きに関するサポートのみとさせていただきます。ご了承ください。
								</div>
							</div>
                        </div>
            ...
            success:function(data){
                ...
                if(data.code==0) {
                    if(type==1) {
                        ...
                        location.href = '/LP/thx1/thxpfcl_test.php';
                    }
                }
            },
            error:function (data) {

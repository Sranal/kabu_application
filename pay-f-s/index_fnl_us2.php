...
<head>     <meta http-equiv="Cache-Control" content="no-cache, no-store, must-revalidate" />     <meta http-equiv="Pragma" content="no-cache" />     <meta http-equiv="Expires" content="0" />
    ...
    <link href="https://www.kabu-college.com/LP/pay-f-s/css/aos.css" rel="stylesheet" type="text/css" />
    <link href="https://www.kabu-college.com/LP/pay-f-s/css/bootstrap.min.css" rel="stylesheet" type="text/css" />
    <link href="https://www.kabu-college.com/LP/pay-f-s/css/featherlight.min.css" rel="stylesheet" type="text/css" />
    <link href="https://www.kabu-college.com/LP/pay-f-s/css/animate.css" rel="stylesheet" type="text/css" />
    <link href="https://www.kabu-college.com/LP/pay-f-s/css/style.css" rel="stylesheet" type="text/css" />
    <style type="text/css">
        .error-tip{
            text-align: left;
            color: red;
...
<div class="e2"><img src="https://www.kabu-college.com/LP/pay-f-s/img/e2.png" data-aos="fade-up" data-aos-easing="ease-out-cubic" data-aos-duration="300" data-aos-delay="300"></div>

<ul>


    <li class="fnl_p1">
        <div class="content fnl_p1h">

            <div class="fnl_us2_02"><img src="https://www.kabu-college.com/LP/pay-f-s/img/fnl_us2_02.png" data-aos="fade-up" data-aos-easing="ease-out-cubic" data-aos-duration="300" data-aos-delay="300"></div>
        ...
        <div class="content2 p2h">
            <div class="p_box">
                <div class="p_right">
                    ...
                    <div class="sp">
                        <div class="pbtn"><a href="#" onclick="submit_card()"><img src="https://www.kabu-college.com/LP/pay-f-s/img/c_btn.png"></a></div>
                        <div class="ptxt">または</div>
                        <div class="pbtn"><a href="#" onclick="submit_bank()"><img src="https://www.kabu-college.com/LP/pay-f-s/img/b_btn.png"></a></div>
                    </div>
                    ...
                    <div class="white_box mb20">
                        ...
                        <div class="com_list">
                            <ul>
                                <li class="pborder"><div class="th"><img src="https://www.kabu-college.com/LP/pay-f-s/img/e3.png"></div><div class="title_set"><div class="title1">【竹】ダイヤモンドVIP</div><div class="title2">専属スタッフ・マンツーマン（通常価格）</div><div class="title3"></div></div>
                                    <div class="num">550,000<span>円（税込）</span></div>
                                </li>
                                <li class="pborder"><div class="th"><img src="https://www.kabu-college.com/LP/pay-f-s/img/e4.png"></div><div class="title_set"><div class="title1">商品値引き</div>
                                  <div class="title2">5万円割引</div>
                                        <div class="title3">※先着30名様限定プレゼント</div></div>
                                    <div class="num cred">▲50,000<span>円引き</span></div></li>
                                <li class="member_special_discount" style="display: none;">
                                    <div class="th"><img src="https://www.kabu-college.com/LP/pay-f-s/img/e4.png"></div>
 ...
 <li><div class="title_set"><div class="title2">割引後の商品小計</div><div class="title3">※３日間限定特別価格</div></div></li>
                    ...
                    <div class="wtitle">【竹】ダイヤモンドVIP</div><div class="tokuten_title">『専属スタッフ・マンツーマン』に付属する商品</div>
                    ...
                    <div class="white_box">
                        ...
                        <div class="com_list">
                            <ul>
                                <li class="pborder"><div class="th"><img src="https://www.kabu-college.com/LP/pay-f-s/img/e5.png"></div><div class="title_set"><div class="title1">【竹】ダイヤモンドVIP専用<br>マンツーマン指導（6カ月間）</div><div class="title2">成功への強制連行：<br /></div>
                                            <div class="tokuten_title">プロ専属『マンツー・プロトコル』</div></li>

                                <li class="pborder"><div class="th"><img src="https://www.kabu-college.com/LP/pay-f-s/img/e6.png"></div><div class="title_set"><div class="title1">不定期レポート＆メッセージ配信（６カ月間）</div><div class="title2">富のカンニングペーパー：</div> <div class="tokuten_title">『プロの自腹・銘柄選定「生」ログ』</div></li>

                                <li class="pborder"><div class="th"><img src="https://www.kabu-college.com/LP/pay-f-s/img/e7.png"></div><div class="title_set"><div class="title1">不定期チェック（６カ月間）</div><div class="title2">分析のズレを即座に矯正：</div><div class="tokuten_title">源太直伝『最終ロジック監査』</div></li>

                                <li class="pborder e9_anchor"><div class="th"><img src="https://www.kabu-college.com/LP/pay-f-s/img/e8.png"></div><div class="title_set"><div class="title1">デジタルコンテンツ（視聴期限無し）</div><div class="title2">資産100倍をさらに加速：</div><div class="tokuten_title">『超加速・錬金ブースター４選』</div><div class="title1">※コンテンツには以下の4つが含まれます</div></li>

                                <li class="pborder"><div class="th"><img src="https://www.kabu-college.com/LP/pay-f-s/img/e9.png"></div><div class="title_set"><div class="tokuten_title">①　ポイントの日・最終実践編</div><div class="title1">ハゲタカの運用サイクルを逆手に取った利益最大化</div></li>

                                <li class="pborder"><div class="th"><img src="https://www.kabu-college.com/LP/pay-f-s/img/e10.png"></div><div class="title_set"><div class="tokuten_title">②　イベント・ドリブン爆速先取り法</div><div class="title1">新商品発表などのイベントなど、<br>ハゲタカが仕掛ける「上昇気流」で利益最大化</div></li>

                                <li class="pborder"><div class="th"><img src="https://www.kabu-college.com/LP/pay-f-s/img/e11.png"></div><div class="title_set"><div class="tokuten_title">③　規制解除V字ブースト・短期急騰術</div><div class="title1">信用規制解除の爆発エネルギーで、<br>短期間で資産をV字成長させるブースター</div></li>

                                <li class="pborder reset_anchor"><div class="th"><img src="https://www.kabu-college.com/LP/pay-f-s/img/e12.png"></div><div class="title_set"><div class="tokuten_title">④　信用期日「強制点火」狙い手法</div><div class="title1">ハゲタカが仕掛けた空売りの、<br>期限切れ強制買いを狙い撃ちした爆益手法</div></li>

                                <li class="pborder"><div class="th"><img src="https://www.kabu-college.com/LP/pay-f-s/img/e13.png"></div><div class="title_set"><div class="title1">デジタルコンテンツ（視聴期限無し）</div><div class="title2">罠を逆利用して『爆益』に変える：</div><div class="tokuten_title">『ハゲタカ識別・板読みスキャナー』</div></li>
								
								<li class="pborder"><div class="th"><img src="https://www.kabu-college.com/LP/pay-f-s/img/e13.png"></div><div class="title_set"><div class="title1">情報配信サービス（６カ月間）</div><div class="title2">富の先乗り強奪：</div><div class="tokuten_title">最上流『情報分析・速報レポート』</div></li>
								
								<li class="pborder"><div class="th"><img src="https://www.kabu-college.com/LP/pay-f-s/img/e13.png"></div><div class="title_set"><div class="title1">情報配信サービス（６カ月間）</div><div class="title2">伝説の1428倍を徹底再現：</div><div class="tokuten_title">満中直伝『決算攻略・錬金プロトコル』</div></li>

                                <li class="pborder"><div class="th"><img src="https://www.kabu-college.com/LP/pay-f-s/img/e14.png"></div><div class="title_set"><div class="title1">シークレット交流（６カ月間）</div><div class="title2">最上流の情報と真の選民階級へ：</div><div class="tokuten_title">『億り人養成・シークレット晩餐会』</div></li>
                    ...
                    <div class="white_box">
                        ...
                        <div class="paylist">
                            ...
                            <ul>
                                <li><img src="https://www.kabu-college.com/LP/pay-f-s/img/e15.png"></li>
                                <li><img src="https://www.kabu-college.com/LP/pay-f-s/img/e16.png"></li>
                                <li><img src="https://www.kabu-college.com/LP/pay-f-s/img/e17.png"></li>
                                <li><img src="https://www.kabu-college.com/LP/pay-f-s/img/e18.png"></li>
                                <li><img src="https://www.kabu-college.com/LP/pay-f-s/img/e19.png"></li>
                    ...
                    <!--<div class="sp"><a href="#" onclick="submit_card()"><div class="sppbtn"><img src="https://www.kabu-college.com/LP/pay-f-s/img/spbtn.png"></div></a></div>-->
                    ...
                    <div class="ssl_box">
                        <ul>
                            ...
                            <li><img src="https://www.kabu-college.com/LP/pay-f-s/img/ssl.png"></li>
                        </ul>
                    ...
                    <div class="cart_box">
                        ...
                        <div class="cnum mb20">
                            <ul>
                                ...
                                <li>今回のご請求額</li>
                                <li class="cred total"><span class="billing_amount">500,000</span>円</li>
                            </ul>
                        </div>

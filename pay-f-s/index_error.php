    ...
    <div class="p_box">
      <div class="p_right">
        <div class="cart_error">
          <div class="title">※お申込情報が重複しています</div>
          <div class="txt"> お申込みいただきました電話番号、メールアドレスは
            過去に先乗り株カレッジの商品への購入申込みを頂いています。<br>
            重複したお支払いを避けるため、ログインしてから申込み手続きをすすめてください。 </div>
        </div>
        <div class="form_box">
          <div class="ftitle">会員ログイン</div>
          <div class="form_e">
            <div class="form_e">
            ...
            <div class="form_e">
              <input name="tel" oninput="value=value.replace(/[^\d]/g,'')" id="tel" maxlength="11" pattern="[0-9]*" type="text" placeholder="パスワード" />
          ...
          <div class="sp mt50"><a href="#" onclick="submit_sp()">
          ...
          <div class="white_box">
            ...
            <div class="com_list">
              <ul>
                <li class="pborder">
                  <div class="th"><img src="https://www.kabu-college.com/LP/pay-f-s/img/e5.png"></div>
                  <div class="title_set">
                    <div class="title1">デジタルコンテンツ（視聴期限無し）</div>
                ...
                <li class="pborder">
                  <div class="th"><img src="https://www.kabu-college.com/LP/pay-f-s/img/e6.png"></div>
                  <div class="title_set">
                    <div class="title1">デジタルコンテンツ（視聴期限無し）</div>
                ...
                <li class="pborder">
                  <div class="th"><img src="https://www.kabu-college.com/LP/pay-f-s/img/e8.png"></div>
                  <div class="title_set">
                    <div class="title1">デジタルコンテンツ（視聴期限無し）</div>
                ...
                <li class="pborder">
                  <div class="th"><img src="https://www.kabu-college.com/LP/pay-f-s/img/e9.png"></div>
                  <div class="title_set">
                    <div class="title1">デジタルコンテンツ（視聴期限無し）</div>

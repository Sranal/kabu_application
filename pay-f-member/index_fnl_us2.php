...
<ul>
    ...
    <li class="fnl_p1">
        <div class="content fnl_p1h">
            ...
            <div class="fnl_us2_02"><img src="https://www.kabu-college.com/LP/pay-f-new/img/fnl_us2_02.png" data-aos="fade-up" data-aos-easing="ease-out-cubic" data-aos-duration="300" data-aos-delay="300"></div>
            ...
            <div class="p_box">
                <div class="p_right">
                    ...
                    <div class="white_box mb20">
                        ...
                        <div class="com_list">
                            <ul>
                                <li class="pborder"><div class="th"><img src="https://www.kabu-college.com/LP/pay-f-new/img/e3.png"></div><div class="title_set"><div class="title1">【竹】ダイヤモンドVIP</div><div class="title2">専属スタッフ・マンツーマン（通常価格）</div><div class="title3"></div></div>
                                    <div class="num">550,000<span>円（税込）</span></div>
                                </li>
                                <li class="pborder"><div class="th"><img src="https://www.kabu-college.com/LP/pay-f-new/img/e4.png"></div><div class="title_set"><div class="title1">商品値引き</div>
 ...
 <li><div class="title_set"><div class="title2">割引後の商品小計</div><div class="title3">※３日間限定特別価格</div></div></li>
                    ...
                    <div class="white_box">
                        ...
                        <div class="com_list">
                            <ul>
                                <li class="pborder"><div class="th"><img src="https://www.kabu-college.com/LP/pay-f-new/img/e5.png"></div><div class="title_set"><div class="title1">【竹】ダイヤモンドVIP専用<br>マンツーマン指導（6カ月間）</div><div class="title2">成功への強制連行：<br /></div>
                                            <div class="tokuten_title">プロ専属『マンツー・プロトコル』</div></li>

                                <li class="pborder"><div class="th"><img src="https://www.kabu-college.com/LP/pay-f-new/img/e6.png"></div><div class="title_set"><div class="title1">不定期レポート＆メッセージ配信（６カ月間）</div><div class="title2">富のカンニングペーパー：</div> <div class="tokuten_title">『プロの自腹・銘柄選定「生」ログ』</div></li>

                                <li class="pborder"><div class="th"><img src="https://www.kabu-college.com/LP/pay-f-new/img/e7.png"></div><div class="title_set"><div class="title1">不定期チェック（６カ月間）</div><div class="title2">分析のズレを即座に矯正：</div><div class="tokuten_title">源太直伝『最終ロジック監査』</div></li>

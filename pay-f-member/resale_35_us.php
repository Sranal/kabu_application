...
<a href="https://www.kabu-college.com/LP/pay/tokusyo.html" target="_blank">こちら</a>をご確認ください。</div>
                    ...
                    <div class="white_box mb20">
                        ...
                        <div class="com_list">
                            <ul>
                                <li class="pborder"><div class="th"><img src="https://www.kabu-college.com/LP/pay-f-new/img/e3.png"></div><div class="title_set"><div class="title1">デジタルコンテンツ（視聴期限無し）</div><div class="title2">先乗り株カレッジ（通常価格）</div><div class="title3"></div></div><div class="num">350,000<span>円</span></div></li>
                                <li><div class="th"><img src="https://www.kabu-college.com/LP/pay-f-new/img/e4.png"></div><div class="title_set"><div class="title1">商品値引き</div><div class="title2">５万円割引</div><div class="title3">※３日間限定プレゼント</div></div><div class="num cred">▲50,000<span>円引き</span></div></li>
                            </ul>
                        </div>
...
<li><div class="num">330,000<span>円</span></div></li>
                    ...
                    <div class="white_box">
                        ...
                        <div class="com_list">
                            <ul>
                                <li class="pborder"><div class="th"><img src="https://www.kabu-college.com/LP/pay-f-new/img/e5.png"></div><div class="title_set"><div class="title1">デジタルコンテンツ（視聴期限無し）</div><div class="title2">教え子が７万円から１億（1428倍）達成！<br />
                                            決算売買の裏技手法を公開</div><div class="title3">※３日間限定プレゼント</div></div><div class="num2">特典プレゼント</div></li>

                                <li class="pborder"><div class="th"><img src="https://www.kabu-college.com/LP/pay-f-new/img/e6.png"></div><div class="title_set"><div class="title1">デジタルコンテンツ（視聴期限無し）</div><div class="title2">板読み短期投資法の解説動画</div><div class="title3">※３日間限定プレゼント</div></div><div class="num2">特典プレゼント</div></li>

...
$error_url = URL_DOMAIN . '/LP/sakinori_pay2_pf/index1_pfcl_k.php';
...
<!--                        <input type="hidden" id="user_id" name="user_id" />-->
                    ...
                    <div class="pay_txt">
						...
						<br/>
						「ポートフォリオ構築術」のみを<br/>
                        68,000円（税込）で購入する場合は⇒<a href="/LP/sakinori_pay2_pf/index2_pf_k.php">こちら</a><br/>
						<br/>
						「マイ投資カレンダー作成術」のみを<br/>
						 30,000円（税込）で購入する場合は⇒<a href="/LP/sakinori_pay2_pf/index3_cl_k.php">こちら</a><br/>
                    </div>

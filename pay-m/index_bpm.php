...
<!--                    <input type="hidden" name="email" value="--><?php //echo isset($user_info['mail_address']) ? $user_info['mail_address'] : ''; ?><!--" />-->
                    ...
                    <div class="sp"><a href="#" onclick="submit_sp()"><div class="sppbtn"><img src="https://www.kabu-college.com/LP/pay/img/spbtn.png"></div></a>
...
<a href="https://www.kabu-college.com/LP/pay/tokusyo.html" target="_blank">こちら</a>をご確認ください。</div>
                    ...
                    <div class="white_box mb20">
                        ...
                        <div class="com_list">
                            <ul>
                                <li class="pborder"><div class="th"><img src="https://www.kabu-college.com/LP/pay/img/e3.png"></div><div class="title_set"><div class="title1">デジタルコンテンツ（視聴期限無し）</div><div class="title2">先乗り株カレッジ（通常価格）</div><div class="title3"></div></div><div class="num">350,000<span>円</span></div></li>
                                <li><div class="th"><img src="https://www.kabu-college.com/LP/pay/img/e4.png"></div><div class="title_set"><div class="title1">商品値引き</div><div class="title2">５万円割引</div><div class="title3">※３日間限定プレゼント</div></div><div class="num cred">▲50,000<span>円引き</span></div></li>
                            </ul>
                        </div>
...
<li><div class="num">330,000<span>円</span></div></li>
                    ...
                    <div class="white_box">
                        ...
                        <div class="com_list">
                            <ul>
                                <li class="pborder"><div class="th"><img src="https://www.kabu-college.com/LP/pay/img/e5.png"></div><div class="title_set"><div class="title1">デジタルコンテンツ（視聴期限無し）</div><div class="title2">教え子が７万円から１億（1428倍）達成！<br />
                                            決算売買の裏技手法を公開</div><div class="title3">※３日間限定プレゼント</div></div><div class="num2">特典プレゼント</div></li>

                                <li class="pborder"><div class="th"><img src="https://www.kabu-college.com/LP/pay/img/e6.png"></div><div class="title_set"><div class="title1">デジタルコンテンツ（視聴期限無し）</div><div class="title2">板読み短期投資法の解説動画</div><div class="title3">※３日間限定プレゼント</div></div><div class="num2">特典プレゼント</div></li>

                                <li class="pborder"><div class="th"><img src="https://www.kabu-college.com/LP/pay/img/e7.png"></div><div class="title_set"><div class="title1">デジタルコンテンツ（視聴期限無し）</div><div class="title2">市場の変化を先読みし利益最大化を狙う<br />
                                            「ポイントの日」の活用法＆実践編</div><div class="title3"></div></div><div class="num2">特典プレゼント</div></li>

                                <li class="pborder"><div class="th"><img src="https://www.kabu-college.com/LP/pay/img/e8.png"></div><div class="title_set"><div class="title1">デジタルコンテンツ（視聴期限無し）</div><div class="title2">新商品発表等のイベントに向かった<br />
                                            株価高騰を捉える手法</div><div class="title3"></div></div><div class="num2">特典プレゼント</div></li>

                                <li class="pborder"><div class="th"><img src="https://www.kabu-college.com/LP/pay/img/e9.png"></div><div class="title_set"><div class="title1">デジタルコンテンツ（視聴期限無し）</div><div class="title2">規制解除後の高確率反転を狙った<br />
                                            短期利食い手法</div><div class="title3"></div></div><div class="num2">特典プレゼント</div></li>

								<li class="pborder"><div class="th"><img src="../pay - m/img/e20.png"></div><div class="title_set"><div class="title1">デジタルコンテンツ（視聴期限無し）</div><div class="title2">信用期日狙いの高確率利食い手法</div><div class="title3"></div></div><div class="num2">特典プレゼント</div></li>

                                <li class="pborder"><div class="th"><img src="https://www.kabu-college.com/LP/pay/img/e10.png"></div><div class="title_set"><div class="title1">自動ツール（６か月間）</div><div class="title2">「自動お宝発見ツール」利用権</div><div class="title3"></div></div><div class="num2">セット商品</div></li>

                                <li class="pborder"><div class="th"><img src="https://www.kabu-college.com/LP/pay/img/e11.png"></div><div class="title_set"><div class="title1">オンライン補講コミュニティ（６か月間）</div><div class="title2">「お宝銘柄発掘ディスカッション」参加権</div><div class="title3"></div></div><div class="num2">セット商品</div></li>

                                <li class="pborder"><div class="th"><img src="https://www.kabu-college.com/LP/pay/img/e12.png"></div><div class="title_set"><div class="title1">追加指導＆交流（６か月間）</div><div class="title2">「月１～2回の定例セミナー」参加権</div><div class="title3"></div></div><div class="num2">セット商品</div></li>

                                <li class="pborder"><div class="th"><img src="https://www.kabu-college.com/LP/pay/img/e13.png"></div><div class="title_set"><div class="title1">半自動システム（６か月間）</div><div class="title2">「簡単日記システム」利用権</div><div class="title3"></div></div><div class="num2">セット商品</div></li>

                                <li class="pborder"><div class="th"><img src="https://www.kabu-college.com/LP/pay/img/e14.png"></div><div class="title_set"><div class="title1">サポート（６か月間）</div><div class="title2">回数無制限、電話＆メールサポート</div><div class="title3"></div></div><div class="num2">セット商品</div></li>
                    ...
                    <div class="sp"><a href="#" onclick="submit_card()"><div class="sppbtn"><img src="https://www.kabu-college.com/LP/pay/img/spbtn.png"></div></a></div>

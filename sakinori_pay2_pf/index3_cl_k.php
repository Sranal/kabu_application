...
$redirect_url = URL_DOMAIN . '/LP/thx1/thxcl.php';
$success_url = URL_DOMAIN . '/LP/thx1/thxcl.php';
$error_url = URL_DOMAIN . '/LP/thx1/thxcl.php';
...
<ul>
    ...
    <li class="p1">
        <div class="content p1h">
            ...
            <div class="e1"><img src="img/PF008.png" data-aos="fade-up" data-aos-easing="ease-out-cubic"
        ...
        <div class="content2 p2h">
            <div class="p_box">
                <div class="p_right">
					...
					<form id="pay" method="post" action="https://www.kabu-college.com/LP/thx1/thxcl.php">
<!--
...
<!--                        <input type="hidden" id="user_id" name="user_id" />-->
                    ...
                    <div class="num_set">
                        <ul>
                            ...
                            <li>
                                <div class="num">30,000<span>円（税込）</span></div>
                    ...
                    <div class="pay_txt">
                        ...
                        <br/>
						※お得な「ポートフォリオ構築術」「マイ投資カレンダー作成術」の<br/><span>期間限定セット（65,000円 税込、クレジットカード決済 可）</span>は⇒<a href="/LP/sakinori_pay2_pf/index1_pfcl_k.php">こちら</a>
						<br/>
                    </div>
            ...
            success:function(data){
                ...
                if(data.code==0) {
                    if(type==1) {
                        ...
                        location.href = '/LP/thx1/thxcl.php';
                    }
                }
            },
            error:function (data) {

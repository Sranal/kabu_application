...
<!--                    <input type="hidden" name="name" value="--><?php //echo isset($user_info['name']) ? $user_info['name'] : ''; ?><!--" />-->
<!--                    <input type="hidden" name="name_kana" value="--><?php //echo isset($user_info['name_phonetic']) ? $user_info['name_phonetic'] : ''; ?><!--" />-->
<!--                    <input type="hidden" name="tel" value="--><?php //echo isset($user_info['tel']) ? $user_info['tel'] : ''; ?><!--" />-->
<!--                    <input type="hidden" name="email" value="--><?php //echo isset($user_info['mail_address']) ? $user_info['mail_address'] : ''; ?><!--" />-->

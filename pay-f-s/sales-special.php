      ...
      <div class="p_box">
        <div class="p_right">
          ...
          <div class="sp"><a href="#" onclick="submit_sp()">
            <div class="sppbtn"><img src="https://www.kabu-college.com/LP/pay-f-s/img/spbtn.png"></div>
            </a></div>
          <div class="white_box mb20 mt20 sp">
            <div class="wtitle">注文する商品</div>
            <div class="com_list">
              <ul>
                <li class="pborder">
                  <div class="th"><img src="https://www.kabu-college.com/LP/pay-f-s/img/e3.png"></div>
                  <div class="title_set">
                    <div class="title1">デジタルコンテンツ（６ケ月間）</div>
                    <div class="title2">先乗り株カレッジ基礎＆常識<br />「オンライン講座」</div>
                ...
                <li>
                  ...
                  <div class="title_set">
                    ...
                    <div class="title2">286,000円割引</div>
                    <div class="title3">※３日間限定プレゼント</div>
                  </div>
                  <div class="num cred">▲286,000<span>円引き</span></div>
                </li>
              </ul>
            </div>
          </div>
          <div class="num_set sp">
            <ul>
              <li>
                <div class="title_set">
			...
			<ul class="sp_border">
              ...
              <li>
                <div class="num">35,000<span>円</span></div>
              </li>
            </ul>
			<ul>
              <li>
                <div class="title_set">
                  <div class="title2">税込通常価格</div>
                </div>
              </li>
              <li>
                <div class="num">385,000<span>円</span></div>
              </li>
            </ul>
			<ul class="sp_border2">
              <li>
                <div class="title_set">
                  <div class="title4 sp_col">ここからさらに！<br />３日間限定割引</div>
                </div>
              </li>
              <li>
                <div class="num sp_col">▲286,000<span>円</span></div>
              </li>
            </ul>
			<ul>
              <li>
                <div class="title_set">
                  <div class="title2">割引後のご請求額</div>
                </div>
              </li>
              <li>
                <div class="num sp_col">99,000<span>円</span></div>
              </li>
            </ul>
          </div>
          <div class="white_box">
		  <div class="wtitle">付属する商品</div>
            <div class="com_list">
              <ul>
                ...
                <li class="pborder pc">
                  ...
                  <div class="title_set">
                    <div class="title1">デジタルコンテンツ（６ケ月間）</div>
                    <div class="title2">先乗り株カレッジ基礎＆常識「オンライン講座」</div>
                    <div class="title3"></div>
                  </div>
                </li>
                ...
                <li class="pborder">
                  ...
                  <div class="title_set">
                    <div class="title1">【源太流三種の神器①】利用権（2ヶ月間）</div>
                ...
                <li class="pborder">
                  <div class="th"><img src="https://www.kabu-college.com/LP/pay-f-s/img/e7.png"></div>
                  <div class="title_set">
                    <div class="title1">【源太流三種の神器②】利用権（2ヶ月間）</div>
                    <div class="title2">「源太カレンダー」の活用法＆実践編</div>
                    <div class="title3"></div>
                  </div>
                </li>
                ...
                <li class="pborder">
                  <div class="th"><img src="https://www.kabu-college.com/LP/pay-f-s/img/e13.png"></div>
                  <div class="title_set">
                    <div class="title1">【源太流三種の神器③】利用権（2ヶ月間）</div>
                ...
                <li class="pborder">
                  <div class="th"><img src="https://www.kabu-college.com/LP/pay-f-s/img/e11.png"></div>
                  <div class="title_set">
                    <div class="title1">オンライン補講コミュニティ（2ヶ月間）</div>
                    <div class="title2">「お宝銘柄発掘ディスカッション」参加権</div>
                    <div class="title3"></div>
                  </div>
                </li>
                <li class="pborder">
                  <div class="th"><img src="https://www.kabu-college.com/LP/pay-f-s/img/e12.png"></div>
                  <div class="title_set">
                    <div class="title1">追加指導＆交流（2ヶ月間）</div>
                    <div class="title2">「月１～2回の定例セミナー」参加権</div>
                    <div class="title3"></div>
                  </div>
                </li>
                <li class="pborder">
                  <div class="th"><img src="https://www.kabu-college.com/LP/pay-f-s/img/e14.png"></div>
                  <div class="title_set">
                    <div class="title1">サポート（2ヶ月間）</div>
            ...
            <div class="ssl_box">
              <ul>
                <li>
                  <div class="stxt">通常の先乗り株カレッジに対し、コンテンツの縮小と提供期間を短縮することで、大幅な割引を実現しています。</div>
                  <div class="stitle"><b>通常価格:<s>３８５,０００円</s>→ ９９,０００円 <br>
                    ※２８６,０００円割引（約75％OFF）</b></div>
                  <div class="stxt">かといって、これで不足分は無く、このコンテンツだけでも十分成果は出せますので、安心してご参加ください。</div>
                  <div class="stitle"><u><b>今だけの超特価、最後のチャンスです。</b></u></div>
                </li>
              </ul>
            </div>
          </div>
        ...
        <div class="p_left pc">
          <div class="cart_box">
            ...
            <div class="cnum gborder">
              <ul>
                <li class="cred">ここからさらに！<br />３日間限定割引</li>
                <li class="cred">▲286,000円</li>
              </ul>
            </div>

            <div class="cnum gborder">
              <div class="ptxt"> コンテンツを縮小<br />
                ＆期間を短縮することで<br />
                大幅な割引を実現 </div>
            </div>
            <div class="cnum mb20">
...
<div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body" style="font-size: 18px"> 登録日時：<span class="add_time"></span></br>
        ...
        <br>
        前回のご注文を取り消して、</br>
        <span class="pay_type"></span> 新規のご注文でよろしいですか？ </div>
                ...
                if(data.code==0) {
                    ...
                    if(type==1) {
                        ...
                        location.href = 'https://secure.telecomcredit.co.jp/inetcredit/secure/order.pl?clientip='+client_ip+'&usrmail=' +
                            ...
                            $('#email').val() + '&usrtel=' + $('#tel').val() + '&goodsId=42' + '&redirect_url='+redirect_url + '&money='+goods_price+'&sendid=' + data.id;

                    }else {

                        location.href = '/LP/thx1/thx3.php';

...
<ul>
    ...
    <li class="p1">
        <div class="content p1h">
            ...
            <div class="e22"><img src="img/e22.png" data-aos="fade-up" data-aos-easing="ease-out-cubic" data-aos-duration="300" data-aos-delay="300"></div>
            <div class="e2"><img src="img/e21.png" data-aos="fade-up" data-aos-easing="ease-out-cubic" data-aos-duration="300" data-aos-delay="300"></div>
                ...
                <div class="p_right">
                    ...
                    <form method="post" id="pay" >
                        <div class="form_box">
                            ...
                            <input type='hidden' name='goods_id' class='goods_id' value='neo-new2'>
                    ...
                    <div class="white_box mb20">
                        ...
                        <div class="com_list">
                            <ul>
                                <li class="pborder"><div class="th"><img src="img/e3.png"></div><div class="title_set"><div class="title1">継続会員</div><div class="title2">「先乗り株カレッジ・ネオα」</div><div class="title3"></div></div><div class="num"><div class="campain_txt">1ヶ月分 払い金額</div>33,000<span>円</span></div></li>
                            </ul>
                        </div>
                    ...
                    <div class="num_set">
                        <ul>
                            <li><div class="title_set"><div class="title2"></div></div></li>
                            <li><div class="num">月額33,000<span>円（税込）</span></div></li>
                        </ul>
                    </div>
                    ...
                    <div class="pay_txt">
                        ...
                        こちらのページからお申込みいただくことで「先乗り株カレッジ・ネオα」のサービスを1か月単位でご継続いただけます。<br />
                        ※クレジット決済の場合、期限満了後は自動更新になります<br />
                        <br />

                        1ヵ月単位の更新でもネオ会員継続時の特典が無効になることはございませんので、ご安心ください。<br />
                        <br />
                        ※「先乗り株カレッジ・ネオα」の詳細については<a href="https://www.kabu-college.com/LP/neoa_198/index.php">こちら</a>をご確認ください。<br />
                        <br />
                    ...
                    <div class="white_box">
                        ...
                        <div class="com_list">
                            <ul>
                                ...
                                <li class="pborder"><div class="th"><img src="img/e12.png"></div><div class="title_set"><div class="title1">追加指導＆交流</div><div class="title2">「月１～2回の定例セミナー」優先権</div><div class="title3">※ネオ継続中は優先的にご案内</div></div><div class="num2">セット商品</div></li>
                    ...
                    <div class="white_box">
                        ...
                        <div class="paylist">
                            ...
                            <ul>
                                ...
                                <div class="ctxt">※クレジット決済の場合、期限満了後は1ヵ月ごとの自動決済になります。</div>
                            </ul>
    ...
    <div class="pay_txt">
						※2025年内は「源太ライブ」「満中株ライブ」をお届けいたします。<br />
						2026年1月以降にご継続された方へは<br />
						別途、新コンテンツについてご案内させていただきます。<br />
						<br />

                    </div>

                    <div class="sp"><a href="#"><div class="sppbtn"><img src="img/spbtn.png"></div></a></div>
...
window.onload = function () {
  location.href = "https://saipon.jp/h/prw030";
};
</script>
</body>

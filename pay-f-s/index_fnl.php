            ...
            <div class="p_box">
                <div class="p_right">
                    ...
                    <div class="white_box mb20">
                        ...
                        <div class="com_list">
                            <ul>
                                <li class="pborder"><div class="th"><img src="https://www.kabu-college.com/LP/pay-f-s/img/e3.png"></div><div class="title_set"><div class="title1">デジタルコンテンツ（視聴期限無し）</div><div class="title2">先乗り株カレッジ（通常価格）</div><div class="title3"></div></div>
                                    <div class="num">550,000<span>円</span></div>
                                </li>
                                <li class="pborder"><div class="th"><img src="https://www.kabu-college.com/LP/pay-f-s/img/e4.png"></div><div class="title_set"><div class="title1">商品値引き</div>
                                        <div class="title2">20万円割引</div><div class="title3">※３日間限定プレゼント</div></div>
                                    <div class="num cred">▲200,000<span>円引き</span></div></li>
                    ...
                    <div class="cart_box">
                        ...
                        <div class="cnum mb20">
                            <ul>
                                ...
                                <li>今回のご請求額</li>
                                <li class="cred total"><span class="billing_amount">350,000</span>円</li>
                            </ul>
                        </div>

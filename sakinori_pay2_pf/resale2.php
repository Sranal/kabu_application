            ...
            <div class="p_box">
                <div class="p_right">
                    ...
                    <div class="form_box">
                        ...
                        <input type='hidden' name='goods_id' class='goods_id' value='3301'>
                        <div class="sp">
                    ...
                    <div class="pay_txt">
                        ...
                        ※「先乗り株カレッジ・ネオ」の詳細については<a href="https://www.kabu-college.com/LP/sakinori_pay2/resale.php
">こちら</a>をご確認ください。<br/>
                        <br/>
                    ...
                    <div class="white_box">
                        ...
                        <div class="com_list">
                            <ul>
								<li class="pborder"><div class="th"><img src="../sakinori_pay2 - Copy/img/e12.png"></div><div class="title_set"><div class="title1">特別特典</div><div class="title2">次回から定例セミナー無料<br/>次回の対面セミナー懇親会を必ずご案内</div>
                                        <div class="title3">※懇親会のご案内は次回のみに限り</div>
                                    </div>

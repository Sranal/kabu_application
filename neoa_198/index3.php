                    ...
                    <div class="white_box">
                        ...
                        <div class="com_list">
                            <ul>
								...
								<li class="pborder"><div class="th"><img src="img/e12.png"></div><div class="title_set"><div class="title1">特別特典</div><div class="title2">次回から定例セミナー無料<br/>次回の対面セミナー懇親会を必ずご案内</div><div class="title3">※懇親会のご案内は次回のみに限り</div><div class="title3">※開催場所や日時は未定</div></div><div class="num2"><b>期間限定</b></div></li>
